...
#property description "Strategy template for MT5 research EAs."

#include <Trade/Trade.mqh>

input string InpStrategyId = "strategy_template";
input long   InpMagicNumber = 200001;
...
{
   // Strategy-specific rules go here. direction: 1 long, -1 short.
   return false;
}
